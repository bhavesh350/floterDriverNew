package cargo.floter.driver.fragments;
...
import cargo.floter.driver.adapter.NavigationDrawerAdapter;
...
//    private RelativeLayout rl_all, rl_quick, rl_offer, rl_more;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        profile_name.setText(MyApp.getApplication().readDriver().getD_name());
